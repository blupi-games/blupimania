...
/* toto boit  la mauvaise bouteille */
/* --------------------------------- */
...
/* toto saute sur l'arrive et monte au ciel */
/* ----------------------------------------- */
...
/* toto baisse une porte lectronique */
/* ---------------------------------- */
...
/* le mchant toto saute sur un dtonateur */
/* --------------------------------------- */
...
/*
	Cherche la table d'icnes correspondant  une action.
 */
...
short* ConvActionToTabIcon (Action action, short typemarche)
{
	switch( action )
	{
		case AC_STOP_E:			return tabiconstope;
		...
		case AC_MARCHE_O:
			if ( typemarche == 1 )	return tabiconmarchefo;
			else					return tabiconmarcheo;
		case AC_MARCHE_S:
			if ( typemarche == 1 )	return tabiconmarchefs;
			else					return tabiconmarches;
		case AC_MARCHE_N:
		...
		case AC_RECULE_O:
			if ( typemarche == 1 )	return tabiconmarchefro;
			else					return tabiconmarcheo;
		case AC_RECULE_S:
			if ( typemarche == 1 )	return tabiconmarchefrs;
			else					return tabiconmarches;
		case AC_RECULE_N:
...
/*
	Cherche la table de mouvement correspondant  une action.
 */
...
short* ConvActionToTabMove (Action action)
{
	switch( action )
	{
		...
		case AC_TOMBE_O:
		case AC_TOMBE_TANK_O:	return tabmovetombeo;
		case AC_TOMBE_S:
...
/*
	Cherche la table d'icnes correspondant  un objet.
 */
...
short* ConvObjetToTabIcon (Objet objet)
{
	switch( objet )
	{
		case OB_BOMBEA:			return tabiconbombea;
		case OB_BOMBEB:			return tabiconbombeb;
		case OB_BOMBEC:			return tabiconbombec;
		case OB_SENSUNIO:		return tabiconsensunio;
		case OB_SENSUNIE:		return tabiconsensunie;
		case OB_SENSUNIN:		return tabiconsensunin;
		case OB_SENSUNIS:		return tabiconsensunis;
		case OB_VITRENS:		return tabiconvitrens;
		case OB_VITREEO:		return tabiconvitreeo;
		case OB_BALLONEX:		return tabiconballonex;
		case OB_BAISSE:			return tabiconbaisse;
		case OB_TELE:			return tabicontele;
		case OB_DETONATEURA:	return tabicondetonateura;
		case OB_DETONATEURB:	return tabicondetonateurb;
		case OB_DETONATEURC:	return tabicondetonateurc;
		case OB_UNSEUL:			return tabiconunseul;
